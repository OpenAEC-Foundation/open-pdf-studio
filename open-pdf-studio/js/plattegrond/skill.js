...
export const PLATTEGROND_PROMPT =
  ...
  '3. Ruimten: app_floorplan {action:"rooms", place:true, seeds:[{x,y,name:"Woonkamer", number:"0.01"}, ...]} (number mag weg). De ruimte volgt uit de wanden: netto oppervlakte binnen de wandvlakken. Per ruimte komt er een ingetogen ruimtevlak (dunne grijze rand, geen arcering of vulling, ACHTER de wanden en kozijnen) en EEN ruimtetag met naam, netto oppervlakte en nummer, in het hart van de ruimte. Zet ruimtenamen dus nooit als los tekstvak. Naam en nummer horen bij de RUIMTE zelf; de tag laat ze zien en is verplaatsbaar. Wijzigen: {action:"rooms", names:[{id (uit het antwoord) of x,y (een punt in de ruimte), name, number}]}. Uitlezen: {action:"rooms"} of inspect geeft per geplaatste ruimte id, name, number en tagIds. Is een tag weg, dan zet place:true met een punt in die ruimte alleen een nieuwe tag neer (geen tweede ruimtevlak). Een ruimte is met een klik niet te selecteren (wanden en kozijnen winnen); in de app via haar tag. Zonder seeds krijg je alleen een overzicht van wat er gevonden is. openEnds in het antwoord zijn wandeinden waar de contour niet sluit - meld die, ga niet raden. Verschoof er later een wand, draai dan {action:"rooms", refresh:true}: elk ruimtevlak rekent zichzelf opnieuw uit en elke ruimtetag krijgt de nieuwe oppervlakte en schuift mee met zijn ruimte.\n' +
