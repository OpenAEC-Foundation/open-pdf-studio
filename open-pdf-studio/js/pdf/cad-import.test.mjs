...
import {
  ...
  grootteTekst, oorsprongVerschuiving, getalTekst, effectiefDoel, isCadTekening, limitsOmvatten, voegLagenSamen,
  gedraaideMaat, decimaalTeken, maakWachtrij, vensterGeldig, buitenBestanden, LAYOUT_PAPIER_STANDAARD,
  papierInstellingen, layoutPagina, papierTeKlein, modelInhoudOpPapier, papierSamenvatting, eenheidMelding,
...
import {
  paginaNoemer, onderleggerFactor, onderleggerVak, rasterPlan, witNaarDoorzichtig, dekkingUitProcent, ONDERLEGGER_DPI,
