...
export const toolStamp = document.getElementById('tool-stamp');
export const toolSignature = document.getElementById('tool-signature');
export const toolMeasureDistance = document.getElementById('tool-measure-distance');
